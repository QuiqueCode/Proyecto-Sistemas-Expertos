    ...
    <Grid sx={{width:550}}>
      <Card
        sx={{
          ...
          height:687.98,
          backgroundImage: `url(${dataObject.image})`,  // Reemplaza con la URL o ruta de tu imagen
...
<div className="rigthContainer">
        ...
        <Grid container>
          <Grid sx={{width:600}}>
            <Card
              sx={{
                boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.3)", height:687.98
              }}
            >
              <Box
                sx={{
